...
class Ur5MoveitE:
    ...
    def __init__(self):
        ...
        self._planning_group = "end_effector2"
        self._commander = moveit_commander.roscpp_initialize(sys.argv)
        self._robot = moveit_commander.RobotCommander()
        self._scene = moveit_commander.PlanningSceneInterface()
        self._group = moveit_commander.MoveGroupCommander(self._planning_group)
...
def main():
    ...
    lst_joint_angles_2 = [math.radians(30),
                          math.radians(-32),
                          math.radians(13),
                          math.radians(-56),
                          math.radians(70),
    ...
    while not rospy.is_shutdown():
        ...
        rospy.sleep(2)
        a.set_joint_angles(lst_joint_angles_1E)
        rospy.sleep(2)

        ur5.set_joint_angles(lst_joint_angles_2)
        rospy.sleep(2)
        a.set_joint_angles(lst_joint_angles_2E)
        rospy.sleep(2)
        ur5.set_joint_angles(lst_joint_angles_3)
        rospy.sleep(2)
        a.set_joint_angles(lst_joint_angles_3E)
        rospy.sleep(2)
